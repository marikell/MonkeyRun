...
//        Node oto = (Node) assetManager.loadModel("Models/Oto/oto.mesh.xml");
        ...
        physicsCharacter = new BetterCharacterControl(1, 1f, 1f);
        ...
        camNode.setLocalTranslation(new Vector3f(0, 50,-30));
    ...
    public void upDateKeys(float tpf,boolean up, boolean down, boolean left, boolean right)
    {
