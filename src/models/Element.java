...
private BulletAppState bulletAppState;
    ...
    public Geometry getBox(){
     ...
     public Element(String name,BulletAppState bulletAppState,AssetManager assetManager, float width, float height, float depth, String defName, ColorRGBA color, Vector3f position, Vector3f rotation){
